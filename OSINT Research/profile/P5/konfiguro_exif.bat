@echo off
REM ============================================
REM EXIF Configuration Script per P5
REM Profili: [I Panjohur] - Mbrojtje Maksimale
REM Strategjia: Zero imazhe personale, Tails OS
REM P5 nuk ngarkon asnjehere imazhe personale
REM Vetem stock photos per testim te framework-ut
REM ============================================

echo Konfigurimi i EXIF per 10 imazhe P5...
echo Simulon strategjine: zero imazhe personale, Tails OS
echo.
...
echo.
echo P5 EXIF konfigurimi perfundoi:
echo   10/10 foto: ZERO metadata (imazhe stock te pastra)
echo   P5 nuk ngarkon, nuk krijon, nuk ndervepron me imazhe
echo   Anonimiteti vizual: ABSOLUT
